...
**Source.** Measurement performed by a parallel Claude session on 2026-05-04 via direct probing; flagged to operator and surfaced into the in-repo doc set as falsifying-evidence-grade per `feedback_substrate-migration-status-quo-bias.md` ("ask 'what falsifying evidence would update you?' early").
