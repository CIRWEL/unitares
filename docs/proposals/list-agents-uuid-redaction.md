...
**Status:** proposal — needs revisions before implementation (council found blockers)
**Author:** Claude_20260425 · **Date:** 2026-04-25
**Reviews:** [code-review](./list-agents-uuid-redaction.code-review.md) · [dialectic-review](./list-agents-uuid-redaction.dialectic-review.md)
