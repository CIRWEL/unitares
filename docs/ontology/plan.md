...
OPEN — actionable
  ...
  R5       memory-deepening tooling — v0.1 KG cite-and-extend spec landed 2026-05-05; shadow scorer + synthetic tests + read-only diagnostic landed 2026-05-06, kept off the R2 hot path. Next action: run shadow samples on real provisional lineage pairs and decide whether durable audit history is warranted.
