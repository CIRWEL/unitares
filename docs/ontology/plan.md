...
OPEN — actionable
  ...
  S7       KG provenance migration — schema decision v0.1 + `provenance_chain` persistence round-trip landed 2026-05-06; next action is authoritative chain snapshot builder from `core.identities`.
